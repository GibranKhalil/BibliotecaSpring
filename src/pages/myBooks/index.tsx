...
import { CarrouselItems } from '@/interface/components/bookCarrousel'
...
export const MyBooksPage = () => {
    return (
        <main className={styles.main}>
            <BookCase bookCaseItems={imgArray} title='Favoritos' />
            <BookCase bookCaseItems={imgArray} title='Estante “Comédia Romântica”' />
            <BookCase bookCaseItems={imgArray} title='Estante “Drama com Romance”' />
        </main>
    )
}